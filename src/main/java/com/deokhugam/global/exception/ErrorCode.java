...
public enum ErrorCode {
    ...
    // Popular Book
    POPULAR_BOOK_INVALID_STATE(HttpStatus.BAD_REQUEST, "인기 도서 정보가 유효하지 않습니다.", "PB-001"),
    POPULAR_BOOK_INVALID_PERIOD_TYPE(HttpStatus.BAD_REQUEST, "인기 도서 집계 기간 타입이 유효하지 않습니다.", "PB-002"),
    // Power User
